...
const StickyWhatsApp = () => {
  ...
  const phoneNumber = contact.phoneClean || "917558988689";
  const message = contact.whatsappMessage || "Hi Gurukripa Builders, I would like to inquire about your construction services.";
